...
**示例1：所有筛选条件**
```http
GET /api/crawler/novels/page?page=0&size=20&platform=ciweimao&keyword=修仙&status=1&tags=玄幻&wordCountMin=1000000&wordCountMax=3000000&sortBy=wordCount&sortOrder=desc
```
...
│  状态: [全部] [连载中] [已完结] [停更]                        │
│                                                               │
│  字数: [全部] [100万以下] [100-300万] [300-500万] [500万以上] │
│                                                               │
│  排序: [更新时间↓] [字数↓]                                    │
│                                                               │
...
- 全部 = 无限制
- 100万以下 = [0, 1000000)
- 100-300万 = [1000000, 3000000]
- 300-500万 = [3000000, 5000000]
